...
function HomeContent() {
  ...
  // Local states for instant UI updates (bulletproof)
  ...
  // Sync with URL parameter exactly once on mount or when URL changes externally (e.g. Footer link)
  useEffect(() => {
  ...
  // Compute filtered & sorted posts synchronously (useMemo instead of useEffect)
  ...
  const handleCategoryClick = (catKey: string) => {
    ...
    // Use history.replaceState to cosmetically update URL without triggering Next.js routing cycle
  ...
  return (
    <div className={styles.mainContainer}>
      <main className={styles.content}>
        ...
        {/* The 'key' forces React to re-mount the feed when state changes, triggering CSS animations */}
